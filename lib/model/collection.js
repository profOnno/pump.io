...
var _ = require("underscore"),
   ...
   Logger = require("bunyan"),
    ...
    log=new Logger({name:'objectmiddleware',streams: [
    {
...
Collection.isList = function(props, callback) {
    ...
    log.debug("Collection.isList");
    log.debug("props.id:"+pretty(props.id));
    propscpy="aarg";
    
    Step(
        function(){
            ActivityObject.getObject("collection",props.id,this);
        },
        function(err,res){
            if(err){
                //res={};//return empty object
                callback(err, null);
            }
            props=res; 
            //log.debug("propscpy:"+propscpy);
            log.debug("props:\n"+pretty(props));
