...
var principal = function(req, res, next) {
    console.log("checking for principal");
    ...
    Step(
        ...
        function(err, principal) {
            if (err) throw err;
            if (principal) {
                console.log("setting session principal user:"+principal);
        ...
        function(err, user) {
            if (err) {
                ...
                // XXX: null on miss
                if (user) {
                    console.log("setting session principal user");
